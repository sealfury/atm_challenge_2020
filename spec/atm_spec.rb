...
describe Atm do 
    ...
    it 'rejects withdraw if account has insufficient funds' do
        ...
        expect(subject.withdraw(105, '1234', acount)).to eq expected_output
    end
    ...
    it 'reject withdraw if the carn is expired' do
        allow(account).to receive(:exp_date).and_return('12/15')
        expected_output = { status: false, message: 'card exired', date: Date.today }
